...
exports.userProfile = async (request, response, next) => {
  try {
    ...
    if (!fetchUserUserProfile.length) return responder(request, response, next, true, 121, {});
...
exports.getGroups = async (request, response, next) => {
  try {
    ...
    if (!groupsFetched.groupsFetched.length) return responder(request, response, next, true, 111, {});
